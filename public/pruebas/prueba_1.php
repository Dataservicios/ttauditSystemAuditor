...
$poll_ids_options = array(9,10,11,16,24,25,26,28);
...
$queEmp = "select id  from polls order by id";
...
// Create new PHPExcel object
	...
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue('F2', utf8_encode('3. Día de Visita'));
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue('G2', utf8_encode('3. Día de Visita'));
	$objPHPExcel->setActiveSheetIndex(1)->setCellValue('H2', utf8_encode('3. Día de Visita'));
