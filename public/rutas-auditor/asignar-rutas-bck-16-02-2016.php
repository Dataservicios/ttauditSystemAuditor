...
<script>
    ...
    var _markersCompany=[];
    var _infoBox;
    var countIBK=0,countRiqra=0,countBayer= 0,countBayerV= 0,countAlicorp= 0,countAlicorpAASS=0, countAlicorpClientes=0,countKasnet=0 , countFullCarga=0, countBCP=0 ,countBIM=0;
