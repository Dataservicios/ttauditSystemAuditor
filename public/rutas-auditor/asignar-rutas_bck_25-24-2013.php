   ...
   // var marker;
    $(document).ready(function($) {
        ...
        function setupMapa(div){
          ...
          // $.post('http://ttaudit.com/getPointStoresForCompanyDepartament',{ departament : "<?php echo $_GET['departament'] ?>" }, function(json){
           $.post('http://localhost/ttaudit.com/backend/ttaudit1/public/getPointStoresForCompanyDepartament',{ departament : "<?php echo $_GET['departament'] ?>" }, function(json){
...
//                );
        ...
        function populateMap(data){
            ...
            function createInfoboxHtml(cadenaRuc,tipo,codclient,fullname, departamento, address, referencia,district,id,company_id) {
...
//    });
    ...
    $('#guarda_ruta').click(function(e) {
        ...
        if(data_store.length < 1) {
           ...
           // $.post('http://ttaudit.com/saveRoute',  { nombreRuta : nombre, user_id : <?php echo $_GET['user_id'] ?> , id_store : data_store },
            $.post('http://localhost/ttaudit.com/backend/ttaudit1/public/saveRoute',  { nombreRuta : nombre, user_id : <?php echo $_GET['user_id'] ?> , id_store : data_store },
                function(data){
                //if (item.latitud != 0 && item.longitud != 0){
                    //console.log(data);
