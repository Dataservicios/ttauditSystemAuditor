        ...
        function populateMap(data){
            ...
            $.each(data, function(i, item){
               // console.log(item);
                ...
                //_markersCompany = [marker,item.company_id];
            ...
            if(countAlicorp > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_alicorp.png"  > ' + countAlicorp +' PDVS </p>')
            if(countIBK > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_interbank.png"  > ' + countIBK +' PDVS </p>')
            if(countKasnet > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_kasnet.png"  > ' + countKasnet +' PDVS </p>')
            if(countFullCarga > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_full_carga.png"  > ' + countFullCarga +' PDVS </p>')
            if(countBCP > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_bcp.png"  > ' + countBCP +' PDVS </p>')
            if(countAlicorpAASS > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_alicorp_aass.png"  > ' + countAlicorpAASS +' PDVS</p>')
            if(countBayer > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_bayer.png"  > ' + countBayer +' PDVS</p>')
            if(countBIM > 0) $('#puntosEmpresa').append('<p><input id="store_" type="checkbox"  checked="checked" id="inlineCheckbox1" value="option1"><img src="img/maker_bim.png"  > ' + countBIM +' PDVS</p>')
