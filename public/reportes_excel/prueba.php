...
$query_detalle_puntos = "call sp_prueba";
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(12 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(13 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(14 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(15 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(16 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(17 , 2), utf8_encode('41. Indicar Rubro') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(18 , 2), utf8_encode('42. ¿Se encuentra abierto el agente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(19 , 2), utf8_encode('42. ¿Se encuentra abierto el agente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(20 , 2), utf8_encode('42. ¿Se encuentra abierto el agente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(21 , 2), utf8_encode('42. ¿Se encuentra abierto el agente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(22 , 2), utf8_encode('42. ¿Se encuentra abierto el agente?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(23 , 2), utf8_encode('43. Al llegar al establecimiento el cliente incógnito deberá preguntar directamente por el agente de Interbank. Ejemplo: Buenos días/tardes, ¿hay agente de Interbank aquí? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(24 , 2), utf8_encode('43. Al llegar al establecimiento el cliente incógnito deberá preguntar directamente por el agente de Interbank. Ejemplo: Buenos días/tardes, ¿hay agente de Interbank aquí? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(25 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(26 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(27 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(28 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(29 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(30 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(31 , 2), utf8_encode('44. ¿El letrero de IBK Agente era visible desde fuera? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(32 , 2), utf8_encode('45. ¿El Interbank Agente es visible estando dentro del establecimiento?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(33 , 2), utf8_encode('45. ¿El Interbank Agente es visible estando dentro del establecimiento?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(34 , 2), utf8_encode('45. ¿El Interbank Agente es visible estando dentro del establecimiento?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(35 , 2), utf8_encode('45. ¿El Interbank Agente es visible estando dentro del establecimiento?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(36 , 2), utf8_encode('45. ¿El Interbank Agente es visible estando dentro del establecimiento?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(37 , 2), utf8_encode('46. ¿Existe algún otro Agente / corresponsal bancario?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(38 , 2), utf8_encode('46. ¿Existe algún otro Agente / corresponsal bancario?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(39 , 2), utf8_encode('47. El CI deberá preguntar,  ¿Puedo pagar una tarjeta de crédito de Interbank acá?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(40 , 2), utf8_encode('47. El CI deberá preguntar,  ¿Puedo pagar una tarjeta de crédito de Interbank acá?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(41 , 2), utf8_encode('48. En el caso de que exista más de un agente en el comercio, preguntar, ¿acá puedo pagar mi teléfono?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(42 , 2), utf8_encode('49. Si responde que si en la P8, preguntar ¿Y en cuál agente me conviene pagar mi teléfono?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(43 , 2), utf8_encode('49. Si responde que si en la P8, preguntar ¿Y en cuál agente me conviene pagar mi teléfono?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(44 , 2), utf8_encode('49. Si responde que si en la P8, preguntar ¿Y en cuál agente me conviene pagar mi teléfono?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(45 , 2), utf8_encode('49. Si responde que si en la P8, preguntar ¿Y en cuál agente me conviene pagar mi teléfono?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(46 , 2), utf8_encode('50. Si me envían dinero del exterior ¿Lo puedo cobrar acá?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(47 , 2), utf8_encode('51. Escoger tipo de Transacción') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(48 , 2), utf8_encode('51. Escoger tipo de Transacción') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(49 , 2), utf8_encode('51. Escoger tipo de Transacción') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(50 , 2), utf8_encode('51. Escoger tipo de Transacción') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(51 , 2), utf8_encode('52. Al preguntar si se podía hacer la operación correspondiente, ¿el dependiente aceptó realizar la operación?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(52 , 2), utf8_encode('53. ¿Su solicitud fue atendido de inmediato?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(53 , 2), utf8_encode('54.  Su solicitud no fue atendida de inmediato porque') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(54 , 2), utf8_encode('54.  Su solicitud no fue atendida de inmediato porque') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(55 , 2), utf8_encode('54.  Su solicitud no fue atendida de inmediato porque') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(56 , 2), utf8_encode('55. Mientras esperaba. ¿La persona que lo atendió se preocupó por su tiempo?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(57 , 2), utf8_encode('55. Mientras esperaba. ¿La persona que lo atendió se preocupó por su tiempo?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(58 , 2), utf8_encode('55. Mientras esperaba. ¿La persona que lo atendió se preocupó por su tiempo?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(59 , 2), utf8_encode('56. Después de esperar') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(60 , 2), utf8_encode('56. Después de esperar') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(61 , 2), utf8_encode('57. ¿La transacción se llegó a realizar de manera exitosa?  (Se considera exitosa cuando se entrega el voucher)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(62 , 2), utf8_encode('58. ¿El agente hizo algún cobro fuera del voucher?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(63 , 2), utf8_encode('59. ¿Cuántos MINUTOS transcurrieron entre que solicitó la transacción y la persona terminó (le entregá el voucher)?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(64 , 2), utf8_encode('60. ¿La persona que lo atendió tuvo que solicitar ayuda de alguna otra persona o hacer alguna consulta al respecto?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(65 , 2), utf8_encode('61. ¿Le entregaron ESPONTÁNEAMENTE un comprobante luego de la transacción? (Si no le entregaron espontáneamente el voucher deben solicitarlo y adjuntarlo al formulario)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(66 , 2), utf8_encode('61. ¿Le entregaron ESPONTÁNEAMENTE un comprobante luego de la transacción? (Si no le entregaron espontáneamente el voucher deben solicitarlo y adjuntarlo al formulario)') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(67 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(68 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(69 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(70 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(71 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(72 , 2), utf8_encode('62. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Por qué no se pudo realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(73 , 2), utf8_encode('63. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Le dieron alguna solución para poder realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(74 , 2), utf8_encode('63. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Le dieron alguna solución para poder realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(75 , 2), utf8_encode('63. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Le dieron alguna solución para poder realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(76 , 2), utf8_encode('63. (SÓLO SI NO SE REALIZÓ LA TRANSACCIÓN) ¿Le dieron alguna solución para poder realizar la transacción?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(77 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(78 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(79 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(80 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(81 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(82 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(83 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(84 , 2), utf8_encode('64. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la amabilidad de la persona que te atendió? ') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(85 , 2), utf8_encode('65. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías el conocimiento de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(86 , 2), utf8_encode('65. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías el conocimiento de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(87 , 2), utf8_encode('65. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías el conocimiento de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(88 , 2), utf8_encode('65. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías el conocimiento de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(89 , 2), utf8_encode('65. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías el conocimiento de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(90 , 2), utf8_encode('66. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la disposición de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(91 , 2), utf8_encode('66. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la disposición de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(92 , 2), utf8_encode('66. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la disposición de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(93 , 2), utf8_encode('66. En una escala del 0 al 3 donde 0 significa Debajo del estándar, 2 Estándar y 3 Superior, ¿cómo calificarías la disposición de la persona que lo atendió?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(94 , 2), utf8_encode('67. El CI deberá mostrar interés: Voy a abrir un negocio, ¿usted me recomendaría tener un agente Interbank?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(95 , 2), utf8_encode('67. El CI deberá mostrar interés: Voy a abrir un negocio, ¿usted me recomendaría tener un agente Interbank?') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(96 , 2), utf8_encode('68. ¿Sabe si tienen alguna página web para conseguir información') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(97 , 2), utf8_encode('69. ¿La persona encargada le proporcionó dicha información') );
$objPHPExcel->setActiveSheetIndex(1)->setCellValue(coordinates(98 , 2), utf8_encode('70. Otras apreciaciones a comentar') );
