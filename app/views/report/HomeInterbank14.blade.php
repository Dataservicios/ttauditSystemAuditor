...
<section>
    ...
    <div class="cuerpo">
        <div class="cuerpo-content">
            <div class="row pt pb">
                <div class="col-sm-9">
                    <h4 class="report-title">Campaña Actual: {{$titulo}}</h4>
                </div>
                <div class="col-sm-3">
                    ...
                    <div class="report-marco ">
                        <div class="contenedor-report">
                            ...
                            <div>
                                ...
                                @if($company_id==14)
                                    <a href="{{route('getDetailResultQuestion', "165/".$valores."-0"."/522")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Local Cerrado</a>
                                    <a href="{{route('getDetailResultQuestion', "165/".$valores."-0"."/523")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Ya no es Agente</a>
                                    <a href="{{route('getDetailResultQuestion', "165/".$valores."-0"."/524")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Pidio Retiro</a>
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <!-- Libreria AMCHART -->
        ...
        <script>
            $(document).ready(function(){
                ...
                $.post('http://ttaudit.com/getTransaccion', function(json){
                    //if (item.latitud != 0 && item.longitud != 0){
