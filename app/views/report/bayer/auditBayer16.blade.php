                        ...
                        <div class="col-sm-12">
                            @foreach($ListProducts as $product)
                                ...
                                <div class="row">
                                        ...
                                        @if($valor['poll_id']<>154)
                                            <div class="col-md-6 pb">
                                                <div class="report-marco ">
                                                    ...
                                                    @if($valor['poll_id']==155)
                                                        <div>
                                                            <a href="{{route('getDetailQuestionBayer', "155/".$valCiudad."-0-0-0"."/".$company_id."/0/".$product->product_id)}}" class="btn btn-primary btn-sm active" role="button">Ver sin Stock</a>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                    @foreach($valores[$product->product_id] as $valor)
                                        @if(($valor['poll_id']<>153) and ($valor['poll_id']<>155))
                                            <div class="col-md-12 pb">
                                                <div class="report-marco ">
                                                    <div class="row pl">
                                                        <div class="col-md-12 ">
