...
@section('pageTitle', $aleatorio)
    ...
    <div class="cuerpo">
        <div class="cuerpo-content">
            ...
            <div class="row pt pb">
                <div class="col-sm-12">
                    <h4 class="report-title">Lista de Premiados {{$campaigne_name}}</h4>
                    ...
                    <div class="row pt pb">
                        <div class="col-sm-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                @else
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><span class="badge">{{$index +1}} </span> {{$detailStore['tipo'].' - '.$detailStore['cadenaRuc'].' - '.$detailStore['fullname'].'('.$detailStore['store_id'].')'}}</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <b> AUDITOR:  </b>{{$detailStore['auditor']}}<br/>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                @foreach ($detailStore['arrayFoto'] as $index1 => $detailFoto)
                                                    ...
                                                    @else
                                                        <a href="{{$detailFoto['urlFoto'].'?Dummie='.$detailFoto['id']}}" class="zoom1 btn btn-default" data-fancybox-group="button"><img src="{{$detailFoto['urlFoto']}}" width="90px" class="img-thumbnail"></a>
                                                    @endif
                                                @endforeach
                                            </div>
                                        </div>
