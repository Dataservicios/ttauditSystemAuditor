                    ...
                    <div class="report-marco ">
                        <div class="contenedor-report">
                            ...
                            <div>
                                ...
                                @if($company_id==12)
                                    <a href="{{route('getDetailResultQuestion', "138/".$valores."-0"."/394")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Local Cerrado</a>
                                    <a href="{{route('getDetailResultQuestion', "138/".$valores."-0"."/395")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Ya no es Agente</a>
                                    <a href="{{route('getDetailResultQuestion', "138/".$valores."-0"."/396")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Pidio Retiro</a>
                                @endif
                            </div>
                        </div>
                    </div>
