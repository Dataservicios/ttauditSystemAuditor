                    ...
                    <div class="row pt pb">
                        <div class="col-sm-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                @else
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><span class="badge">{{$index +1}} </span> {{$detailStore['type'].' - '.$detailStore['fullname']}}</h3>
                                    </div>
                                    <div class="panel-body">

                                        <div class="row">
                                            <div class="col-sm-8">
                                                <b> TIPO BODEGA:  </b>{{$detailStore['tipo_bodega']}}<br/>
                                                <b> DISTRIBUIDOR:  </b>{{$detailStore['distributor']}}<br/>
