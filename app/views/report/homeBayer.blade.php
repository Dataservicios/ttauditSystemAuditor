...
<section>
    ...
    <div class="cuerpo">
        <div class="cuerpo-content">
            <div class="row pt pb">
                <div class="col-sm-9">
                    <h4 class="report-title">Resumen Período: {{$titulo}}</h4>
                    ...
                    <div class="row">
                        <div class="col-md-12 pb">
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', $valPolls[$company_id]['abierto']."/".$valores."-0-0-0-".$horizontalLink."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Locales Cerrados</a>
                                </div>
                            </div>

                            <div class="report-marco ">
                                <div class="contenedor-report">
                                    <h4>Recomendaciones por producto</h4>
                                </div>
                                <div class="grafico-circle">
                            ...
                            <div class="report-marco ">
                                ...
                                <div class="contenedor-report">
                                    <h4>Visibilidad Bayer</h4>
                                </div>
                                <div class="grafico-circle">
                                    <div id="chartdiv4" style="width: 100%; height: 250px;" ></div>
                                </div>
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', $valPolls[$company_id]['exhibicion']."/".$valores."-1-0-0-".$horizontalLink."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver exhibiciones</a>
                                </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailWinnersBayer', $valPolls[$company_id]['premio']."/".$valores."-".$horizontalLink."/".$company_id."/".$aleatorio)}}" class="btn btn-primary btn-sm active" role="button">Ver Premiados</a>
                                    <a href="{{route('getDetailQuestionBayer', $valPolls[$company_id]['premio']."/".$valores."-0-0-0-".$horizontalLink."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">No recibieron Premio</a>
                                </div>
                            </div>
