                    ...
                    <div class="row">
                        <div class="col-md-12 pb">
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', "194/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Locales Cerrados</a>
                                </div>
                            </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailWinnersBayer', "199/".$valores."/".$company_id)}}" class="btn btn-primary btn-sm active" role="button">Ver Premiados</a>
                                    <a href="{{route('getDetailQuestionBayer', "199/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">No aceptaron Premio</a>
                                </div>
                            </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', "152/".$valores."-1-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver exhibiciones</a>
                                </div>
