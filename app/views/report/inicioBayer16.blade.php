                    ...
                    <div class="row">
                        <div class="col-md-12 pb">
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', "151/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Locales Cerrados</a>
                                </div>
                            </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailWinnersBayer', "156/".$valores."/".$company_id)}}" class="btn btn-primary btn-sm active" role="button">Ver Premiados</a>
                                    <a href="{{route('getDetailQuestionBayer', "147/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">No recibieron Premio</a>
                                </div>
                            </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div class="contenedor-report">
                                    <h4>No presentan visibilidad Bayer</h4>
                                </div>
                                <div class="grafico-circle">
