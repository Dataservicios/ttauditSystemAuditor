                    ...
                    <div class="row">
                        <div class="col-md-12 pb">
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailQuestionBayer', "103/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Locales Cerrados</a>
                                </div>
                            </div>
                            ...
                            <div class="report-marco ">
                                ...
                                <div>
                                    <a href="{{route('getDetailWinnersBayer', $company_id."/".$valores)}}" class="btn btn-primary btn-sm active" role="button">Ver Premiados</a>
                                    <a href="{{route('getDetailQuestionBayer', "105/".$valores."-0-0-0"."/".$company_id."/0")}}" class="btn btn-primary btn-sm active" role="button">No aceptaron Premio</a>
                                </div>
                            </div>
