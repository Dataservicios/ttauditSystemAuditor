...
<section>
    ...
    <div class="cuerpo">
        <div class="cuerpo-content">
            <div class="row pt pb">
                <div class="col-sm-9">
                    <h4 class="report-title">Período Actual: {{$titulo}}</h4>
                </div>
                <div class="col-sm-3">
                    ...
                    <div class="report-marco ">
                        <div class="contenedor-report">
                            <div class="btn-group" role="group" aria-label="...">
                                <div   class="btn btn-default btn-si">Base Agentes</div>
                                <div   class="btn btn-default btn-valor">{{$cantidadStoresForCampaigne}}</div>
                            </div>
                            <div class="btn-group" role="group" aria-label="...">
                                <div   class="btn btn-default btn-si">Agentes Programados</div>
                                <div   class="btn btn-default btn-valor">{{$cantidadStoresRouting}}</div>
                            </div>
                            <div class="btn-group" role="group" aria-label="...">
                                <div   class="btn btn-default btn-si">Agentes visitados</div>
                    ...
                    <div class="report-marco ">
                        <div class="contenedor-report">
                            ...
                            <div>
                                ...
                                @if($company_id==45)
                                    <a href="{{route('getDetailResultQuestion', $abierto."/".$valores."-0"."/".$abiertoLocalCerrado)}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Local Cerrado</a>
                                    <a href="{{route('getDetailResultQuestion', $abierto."/".$valores."-0"."/".$abiertoYaNoAgente)}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Ya no es Agente</a>
                                    <a href="{{route('getDetailResultQuestion', $abierto."/".$valores."-0"."/".$abiertoPidioRetiro)}}" class="btn btn-primary btn-sm active" role="button">Ver Detalle Pidio Retiro</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="row pt pb">
                <div class="col-sm-12">
                    <div class="report-marco ">
                        <div class="contenedor-report">
                            <h4>Transacciones/Operaciones</h4>
    ...
    <!-- Libreria AMCHART -->
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $.post(url_base + '/getEjecutivosForCompany',{ company_id : company_id }, function(json){
                    //if (item.latitud != 0 && item.longitud != 0){
                    poblandoCombo(json,2);
                });
                $('#rubro').prop('disabled',false);

                $.post(url_base + '/getRubros',{ company_id : company_id }, function(json){
                    //if (item.latitud != 0 && item.longitud != 0){
                    poblandoCombo(json,3);

                });

                $.post(url_base + '/getTransaccion',{ company_id : company_id },
                        function(json){
            ...
            function ejecutaEvento(valor,tipo){
                ...
                if (tipo==1){
                    ...
                    if ((user != 1) && (user != 2) && (user != 3) && (user != 4) && (user != 5)){
                        $('#distrito').prop('disabled',false);
                        $('#distrito option').remove();
                        $.post(url_base+'/getDistrictxRegion',{ region : valor.value }, function(json){
                            //if (item.latitud != 0 && item.longitud != 0){
                ...
                if (tipo==2){
                    ...
                    //});
                    $.post(url_base + '/getEjecutivoxRegionxDistric',{ district : valor.value }, function(json){
                        //if (item.latitud != 0 && item.longitud != 0){
                        poblandoCombo(json,tipo);
                    });
                }
        ...
        <script>
            ...
            creaGraficoColumnas(chartData1,charDiv1,true);
