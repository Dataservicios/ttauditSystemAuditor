                                ...
                                <div class="report-marco ">
                                    <div class="contenedor-report">
                                        ...
                                        <div class="grafico-circle">
                                            ...
                                            @if (($resumen['poll_id'] == 113) or ($resumen['poll_id'] == 114) or ($resumen['poll_id'] == 118) or ($resumen['poll_id'] == 123))
                                                <div>
