                        ...
                        <div class="report-marco ">
                            <div class="contenedor-report">
                                ...
                                <div class="btn-group" role="group" aria-label="...">
                                    ...
                                    <div   class="btn btn-default btn-valor"></div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                        ...
                                        @foreach($Polls as $index => $poll)
                                            @if(count($valFotos[$poll->id]['responses'])>0)
                                                @if(count($valFotos[$poll->id]['responses']['poll_details'])>0)
                                                    {{"(".$valFotos[$poll->id]['responses']['poll_details'][0]['poll_detail']->auditor.")"}}
                                                    <?php $auditor_id=$valFotos[$poll->id]['responses']['poll_details'][0]['poll_detail']->auditor?>
                                                @endif
                                            @endif
                                            @if ($index==0)
                                                    <?php break; ?>
                                ...
                                <div class="btn-group" role="group" aria-label="...">
                                    ...
                                    <div   class="btn btn-default btn-valor">{{$objStore->created_at}}</div>
                                </div>
                                <div class="btn-group" role="group" aria-label="...">
                                    <div   class="btn btn-default btn-si">Fecha cerrado:</div>
                                    <div   class="btn btn-default btn-valor">{{$objStore->updated_at}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                                            ...
                                                            @foreach($objetoArray['objeto'] as $objeto)
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 ">
                                                                        ...
                                                                        {{ Form::hidden('user_id', $auditor_id) }}
                                                                        {{ Form::hidden('fecha',$objStore->updated_at) }}
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    {{Form::hidden('user_id', $auditor_id, ['id'=>'user_id'])}}
                                                                                    @if($poll_detail['poll_detail']->product_id<>0)
                                                                                        <div class="mensaje-option"></div>
                                ...
                                <div id="myModalInsert{{$poll->id}}" class="modal fade" tabindex="-1" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mensaje-option"></div>
                                                <p>Fecha auditoria: {{$objStore->created_at}}</p>
                                                {{Form::hidden('company_id_insert', $company_id, ['id'=>'company_id_insert'])}}
                                                {{Form::hidden('user_id_insert', $auditor_id, ['id'=>'user_id_insert'])}}
                                                {{Form::hidden('store_id_insert', $objStore->id, ['id'=>'store_id_insert'])}}
                                                {{Form::hidden('fecha_insert'.$poll->id, $objStore->created_at, ['id'=>'fecha_insert'.$poll->id])}}
                                                <div class="mensaje-option"></div>
                                                @if(count($valFotos[$poll->id]['products'])>0)
